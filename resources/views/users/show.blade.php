            ...
            <div class="card shadow-sm border-0 overflow-hidden">
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 border rounded bg-light">
                                <label class="text-muted small fw-bold text-uppercase d-block mb-1">Data de Cadastro</label>
                        ...
                        <div class="col-md-12">
                            <div class="p-3 border rounded bg-light">
                                <label class="text-muted small fw-bold text-uppercase d-block mb-2">Versionamentos Vinculados</label>
                                @forelse($user->versionings as $versioning)
                                    <span class="badge bg-secondary me-1">{{ $versioning->name }}</span>
                                @empty
                                    <span class="text-muted italic">Nenhum versionamento vinculado.</span>
                                @endforelse
                            </div>
                        </div>
                    </div>
