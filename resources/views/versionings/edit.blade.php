                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <input type="text" name="version_number" class="form-control @error('version_number') is-invalid @enderror" 
                                       placeholder="ex: 1.0.4" value="{{ old('version_number', $versioning->version_number) }}" required>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <input type="text" name="release_date" id="release_date" 
                                       ...
                                       value="{{ old('release_date', $versioning->release_date ? $versioning->release_date->format('d/m/Y') : '') }}"
                                       autocomplete="off">
                            </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <textarea name="changelog" class="form-control @error('changelog') is-invalid @enderror" 
                                          rows="4" placeholder="Descreva as melhorias...">{{ old('changelog', $versioning->changelog) }}</textarea>
                            </div>
                        </div>
