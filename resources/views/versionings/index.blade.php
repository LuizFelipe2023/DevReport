                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('versionings.show', $v->id) }}" class="btn btn-sm shadow-sm d-flex align-items-center justify-content-center"
                                        style="background-color: #38bdf8; color: #0f172a; width: 32px; height: 32px; border-radius: 8px;">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>
                                    <a href="{{ route('versionings.edit', $v->id) }}" class="btn btn-sm shadow-sm d-flex align-items-center justify-content-center"
                                        style="background-color: #fbbf24; color: #0f172a; width: 32px; height: 32px; border-radius: 8px;">
                                        <i class="bi bi-pencil-fill"></i>
                                    </a>
                                    <button type="button" class="btn btn-sm shadow-sm d-flex align-items-center justify-content-center border-0"
